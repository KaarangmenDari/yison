...
<head>
    ...
    <!-- Title Page-->
    <title>YTHVSM Visitors Forms</title>
...
<body class="animsition">
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Vehicle Number</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="department" name="department" placeholder="Vehicle Number" class="form-control" required="">
